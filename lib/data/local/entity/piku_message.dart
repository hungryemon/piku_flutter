...
part 'piku_message.g.dart';

/// {@category FlutterClientSdk}
@JsonSerializable(explicitToJson: true)
@HiveType(typeId: PIKU_MESSAGE_HIVE_TYPE_ID)
class PikuMessage extends Equatable {
  ...
  factory PikuMessage.fromJson(Map<String, dynamic> json) =>
      _$PikuMessageFromJson(json);

  Map<String, dynamic> toJson() => _$PikuMessageToJson(this);
